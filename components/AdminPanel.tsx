  ...
  const getContractHTML = (client: Client) => {
    ...
    return `
      ...
      <body>
        ...
        <div class="clause-title">CLÁUSULA SÉTIMA – DA GARANTIA LOCATÍCIA</div>
        ${client.rental_warranty === 'Seguro Fiança' ? `
          <p class="clause-text">O seguro de Fiança Locatícia contratado pelo(s) LOCADOR(ES) junto a PORTO SEGURO CIA. DE SEGUROS GERAIS, em que a vigência inicial será a data de protocolo da proposta ou data distinta acordada entre as partes e a vigência final será a data do término do contrato de locação, garantirá esta locação, nos termos do inciso III, do artigo 37 da Lei do Inquilinato, mediante pagamento de prêmio, ressalvadas as exceções previstas nas condições gerais.</p>
          <p class="clause-text">A PORTO SEGURO CIA. DE SEGUROS GERAIS, disponibiliza a possibilidade de contratação de produtos com condições diferentes em relação ao Limite Máximo de Garantia (LMG). No SEGURO FIANÇA LOCATÍCIA TRADICIONAL, o LMG é a soma dos limites máximos de indenização (LMI) das coberturas contratadas.</p>
          <p class="clause-text">No SEGURO FIANÇA LOCATÍCIA ESSENCIAL, o LMG da apólice é igual ao LMI da cobertura de ALUGUEL. Quando contratada apenas a Cobertura Básica - Não Pagamento de Aluguéis, o Limite Máximo de Garantia da apólice será igual ao Limite Máximo de Indenização desta mesma cobertura.</p>
          <p class="clause-text">Quando houver a contratação de coberturas adicionais, o Limite Máximo de Garantia da apólice será menor que a soma dos Limites Máximos de Indenização das coberturas contratadas.</p>
          <p class="clause-text">São de conhecimento do(s) LOCADOR (es) e LOCATÁRIO(S) as Condições Gerais do seguro de Fiança Locatícia, sendo que para a contratação da apólice, LOCADOR (es) e LOCATÁRIO(s) definiram previamente, mediante acordo, a seguradora, o corretor de seguros e os limites da apólice. Para efeito desta garantia, LOCADOR (es) e LOCATÁRIO(s) acordam que os prêmios iniciais e renovações do seguro de fiança locatícia, calculados conforme NORMAS VIGENTES, serão pagos pelo(s) LOCATÁRIOS(s). de acordo com o inciso XI, do artigo 23 da lei do inquilinato, sob pena de rescisão desta locação, com o consequente despejo e cancelamento da apólice. Na hipótese de inadimplência do(s) LOCATÁRIO(s), o(s) LOCADOR (es) poderá(ão) efetuar o pagamento dos prêmios, para que a apólice permaneça vigente.</p>
          <p class="clause-text">Em caso de prorrogação do contrato de locação, com alterações que influenciam nas condições iniciais de aceitação, a seguradora se reservará ao direito de realizar nova análise do risco. LOCADOR(ES) e LOCATÁRIO (S) declaram que até a data da contratação do seguro, todas as obrigações contratuais foram cumpridas pelas partes, tendo o (s) LOCATÁRIO (s) adimplido pontualmente todos os aluguéis e encargos da locação. Declaram ainda que não há sinistro a reclamar, quanto a aluguéis e encargos, bem como estão cientes que não haverá cobertura securitária para os aluguéis e encargos vencidos e vincendos, caso seja identificado que o primeiro inadimplemento tenha ocorrido antes da contratação do seguro, ficando a seguradora, desobrigada e isenta de toda e qualquer responsabilidade, ainda que haja reclamação futura de inadimplência anterior a data de contratação do seguro.</p>
          <p class="clause-text">A apólice garantirá exclusivamente as coberturas especificadas na proposta de seguro. Eventuais débitos decorrentes do presente contrato, não pagos pelo(s) LOCATÁRIO (s) após regularmente instados a tanto serão comunicados às entidades mantenedoras de bancos de dados de proteção ao crédito (Serasa, SPC, etc.), quer pelos Locadores, quer pela Seguradora. Tais débitos incluem todas as despesas com as medidas judiciais cabíveis. Notificações em geral, inclusive sobre eventuais débitos decorrentes do presente contrato poderá ser realizado ao(s) LOCATÁRIO(S), via e-mail.</p>
          <p class="clause-text">1944.09.00.I – DEZEMBRO/2025</p>
          <p class="clause-text">As Partes convencionam que a Seguradora sub-rogar-se-á automaticamente no(s) direito(s) do(s) LOCADOR (es) pelos débitos em aberto do(s) LOCATÁRIO (s) com o pagamento do(s) adiantamento(s) da indenização ou da indenização final ao(s) LOCADOR (es). Para exercer os direitos e dar cumprimento às obrigações desse contrato, os LOCATÁRIOS declaram-se solidários entre si e constituem-se reciprocamente PROCURADORES, conferindo-se mutuamente poderes especiais para receber citações, notificações e intimações, confessar, desistir, e assinar tudo quanto se tornar necessário, transigir em Juízo ou fora dele, fazer acordos, firmar compromissos judiciais ou extrajudiciais, receber e dar quitação</p>
        ` : `
        ...
        <div class="clause-title">CLÁUSULA OITAVA – RESIDENTES DO IMÓVEL</div>
        ...
        <div class="clause-title">CLÁUSULA NONA – DAS MODIFICAÇÕES NO IMÓVEL</div>
        ...
        ${client.rental_warranty === 'Seguro Fiança' ? `
          <p class="clause-text">Quando contratada a cobertura adicional de Danos ao Imóvel, passa a ter validade a seguinte cláusula:</p>
          <p class="clause-text">LOCADOR (es) e LOCATÁRIO(s) declara(m) que o Laudo de Vistoria Inicial, com descrição do estado do imóvel, foi elaborado antes da posse do imóvel, bem como o(s) LOCATÁRIO(s) concorda(m) com o conteúdo do laudo.</p>
          <p class="clause-text">O(s) LOCATÁRIO(s) declaram para todos os fins e efeitos de direito que recebe(m) o imóvel locado no estado em que se encontra de conservação e uso, identificado no Relatório referente ao estado de uso e conservação do imóvel o qual é parte integrante deste contrato, assinado por todos os contratantes, obrigando-se e comprometendo-se a devolvê-lo nesse estado, independentemente de qualquer aviso ou notificação prévia, e qualquer que seja o motivo de devolução, sob pena de incorrer nas cominações previstas neste contrato ou estipuladas em lei, além da obrigação de indenizar por danos ou prejuízos decorrentes da inobservância dessa obrigação, salvo as deteriorações decorrentes do uso normal do imóvel.</p>
        ` : ''}
