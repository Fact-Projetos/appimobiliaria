      ...
      <div className="bg-[#fcfcfc] min-h-screen">
        ...
        <div className="bg-white border-b border-gray-50 pt-10 pb-6 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <h3 className="text-3xl md:text-4xl font-light text-black tracking-tight mb-8">Curadoria exclusiva de <span className="font-bold underline decoration-[#4A5D23]/30">aluguéis e hospedagens</span></h3>
            {dbError && (
